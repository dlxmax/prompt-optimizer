...
4. **Compact**: after restructuring and reorganizing are complete, apply a final compaction pass:
   ...
   4.9. Remove courtesy markers (distinct from 4.8 escape hatches): "kindly," "please," "feel free to," "as you see fit," "we'd appreciate if." Courtesy does not soften directive force the way escape hatches do, but it adds tokens with zero signal. Imperatives outperform polite imperatives on instruction-following benchmarks (IFBench 2026; AGENTIF, arxiv 2505.16944).
   4.10. Strip filler connectives: "Furthermore," "In addition," "Moreover," "Additionally," "It is important to note that," "It should be mentioned that." These are LLMLingua-2's first-pass deletions (NAACL 2025, aclanthology.org/2025.naacl-long.368.pdf) and carry zero signal in numbered or bulleted directive blocks.
   4.11. Replace threshold prose with numeric notation: "scores below three" → "≤2"; "more than five examples" → ">5"; "between 20 and 40 percent" → "20-40%". Numeric notation is more directive-stable on Gemma 4 (see GEMMA4_API_BEST_PRACTICES.md) and saves 4-8 tokens per occurrence.
