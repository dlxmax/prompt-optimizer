...
14. Gemini 3.x parameter-removal scan. Fires when target is Gemini 3.5 Flash, Gemini 3.1 Pro Preview, Gemini 3.1 Flash-Lite, Gemini 3 Flash Preview, or Gemini 3 Pro Preview (or `Target model: Gemini 3.x`).
   ...
   14.9. Consistent structure: XML XOR Markdown for section delimiters. Pick one and stay with it. If mixed, convert the minority style to the dominant one. Scopes to section delimiters only; the curly-brace variable-substitution convention from rule 10 is unrelated.
